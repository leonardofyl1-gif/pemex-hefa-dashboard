(()=>{
  ...
  const timer=setInterval(()=>{
    ...
    pretreatment.innerHTML=`
      <div class="hydro-pretreatment-parent"><div class="parent-head"><span class="parent-no">02</span><div><h3>02 – Pretratamiento HVO/HEFA del feedstock (fuera de Tula)</h3><p>Este bloque agrupa el <strong>pretratamiento HVO/HEFA del feedstock</strong> asociado al proyecto HydroFlex. Aquí se realizan, de forma típica en la industria, las etapas de desgomado (degumming), blanqueo con tierras (bleaching), secado y filtración de pulido, que reducen gomas, fósforo, metales, agua y sólidos antes de la sección catalítica HydroFlex.</p></div></div></div>
    ...
    const p02=stage02.querySelector('.panel-title'); if(p02) p02.textContent='Punto de control · bloque 02 completo';
    const e02=stage02.querySelector('.stage-explain'); if(e02) e02.innerHTML='<strong>Este tren de pretratamiento HVO/HEFA se diseña específicamente para el proyecto HydroFlex, siguiendo el esquema estándar de la industria; los detalles exactos se definen con el licenciante y los proveedores de pretreatment.</strong> El bloque ocurre fuera de Tula y prepara el feedstock antes del transporte y de los controles posteriores.';
