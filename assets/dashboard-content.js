...
(()=>{
  ...
  const applyVegan=()=>{
    ...
    if(physical07) physical07.textContent='Proceso físico (enfría y estabiliza el efluente para retirar H₂ (hidrógeno), gases y componentes muy ligeros):';
    ...
    <div class="blend-matrix-content">
      ...
      <table class="blend-matrix-table" aria-label="Comportamiento de las variables de la Matriz Maestra al mezclar">
        ...
        <tbody>
          ...
          <tr><td><strong>Composición y operación</strong><br>T02, T03, T19, T22</td><td>El perfil de ácidos grasos, carbono (C) / hidrógeno (H), insaturación y oxígeno cambian con la receta. Influyen en fusión, viscosidad, estabilidad y demanda de hidrógeno; se calculan para diseñar la mezcla y se verifican según el plan analítico.</td></tr>
          <tr><td><strong>Compatibilidad HEFA</strong><br>T10–T13, T15–T18, T20, T26–T27</td><td>Fósforo, metales, nitrógeno (N), azufre (S), sales, silicio, jabones, insaponificables, TAN, sodio (Na) + potasio (K) y el umbral de nitrógeno (N) cambian con cada lote. La estimación sirve para formular; la especificación técnica aplicable define la liberación.</td></tr>
...
(()=>{
  ...
  if(panelTitle) panelTitle.textContent='Conversión química';
  if(explain) explain.innerHTML="<div class=\"pretreatment-explainer isom-summary\">\n  <p class=\"explainer-lead\"><strong>HDO convierte la grasa en hidrocarburos.</strong> Isomerization cambia la forma de esos hidrocarburos para que funcionen mejor, especialmente a bajas temperaturas.</p>\n\n  <div class=\"correction-card hdo-summary-input\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">+</span><strong>Entra a Stage 2</strong></div>\n    <ul class=\"correction-list\">\n      <li>Parafinas lineales provenientes del HDO</li>\n      <li>Hidrógeno (H₂)</li>\n      <li>Contacto con un catalizador de isomerización</li>\n    </ul>\n  </div>\n\n  <div class=\"correction-card isom-summary-transform\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">↝</span><strong>Se transforma</strong></div>\n    <ul class=\"correction-list\">\n      <li>Las cadenas lineales se reorganizan y se vuelven ramificadas.</li>\n      <li>La isomerización cambia principalmente la forma, no elimina el carbono.</li>\n      <li>Una parte de las cadenas puede acortarse mediante <em>selective hydrocracking</em>.</li>\n    </ul>\n    <div class=\"hdo-equation\">\n      <div>Parafina lineal</div>\n      <div class=\"hdo-arrow\">↓ Isomerization</div>\n      <div>Iso-parafina ramificada</div>\n    </div>\n  </div>\n\n  <div class=\"correction-card correction-keep\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">→</span><strong>Sale y continúa</strong></div>\n    <ul class=\"correction-list\">\n      <li>Iso-parafinas / parafinas ramificadas</li>\n      <li>Algunas cadenas más cortas</li>\n      <li>Otros hidrocarburos renovables</li>\n    </ul>\n    <div class=\"correction-destination\">Esta mezcla pasa a 08 · Separation / Fractionation.</div>\n  </div>\n\n  <p class=\"process-additive\"><strong>Reactivo y medio de reacción:</strong> la corriente opera con H₂ (hidrógeno) y entra en contacto con un catalizador, bajo temperatura y presión elevadas. Las condiciones específicas de Ecofining no se muestran.</p>\n\n  <details class=\"explainer-detail\">\n    <summary>Ver explicación guiada · ¿cómo se transforman las parafinas lineales en iso-parafinas?</summary>\n    <div class=\"explainer-body hdo-detail-body\">\n      <div class=\"hdo-explainer isom-explainer\">\n        <div class=\"hdo-card isom-card isom-input\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">1</span>¿Qué entra?</div>\n          <p>Entran principalmente <strong>parafinas lineales provenientes del HDO + hidrógeno (H₂)</strong>. La corriente pasa por un catalizador de isomerización.</p>\n          <div class=\"hdo-equation\">\n            <div class=\"hdo-caption\">Parafina lineal · cadena de C (carbono) y H (hidrógeno)</div>\n            <div class=\"hdo-molecule-line\">C–C–C–C–C–C–C–C</div>\n          </div>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-problem\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">2</span>¿Cuál es el problema de las cadenas rectas?</div>\n          <p>Las parafinas lineales se acomodan y cristalizan con mayor facilidad. Esto puede volver el producto más ceroso y perjudicar su comportamiento a bajas temperaturas.</p>\n          <div class=\"isom-packing\">\n            <div class=\"isom-packing-box\">\n              <strong>Cadena recta</strong>\n              <code>C–C–C–C–C\nC–C–C–C–C\nC–C–C–C–C</code>\n              <span class=\"hdo-caption\">Se acomodan fácilmente</span>\n            </div>\n            <div class=\"isom-packing-box\">\n              <strong>Cadena ramificada</strong>\n              <div class=\"isom-branch\">  C\n  │\nC–C–C–C\n    │\n    C</div>\n              <span class=\"hdo-caption\">Se acomodan con mayor dificultad</span>\n            </div>\n          </div>\n          <div class=\"isom-saf-properties\">\n            <div class=\"isom-property cold\"><b>Punto de fusión / congelación</b>Una parafina lineal individual suele fundir y cristalizar con mayor facilidad. En la mezcla de combustible, la propiedad que se verifica es el punto de congelación.</div>\n            <div class=\"isom-property flow\"><b>Flujo y viscosidad en frío</b>Los cristales y las cadenas largas pueden dificultar el flujo. La ramificación ayuda a conservar la fluidez a bajas temperaturas.</div>\n            <div class=\"isom-property range\"><b>Rango de ebullición</b>La longitud de las cadenas influye en qué fracción podrá recuperarse como jet fuel durante la separación posterior.</div>\n            <div class=\"isom-property density\"><b>Densidad</b>Es importante para la energía disponible por volumen, pero depende de la composición completa. La isomerización por sí sola no garantiza corregirla.</div>\n          </div>\n          <p class=\"hdo-callout\">Para SAF, el objetivo principal de la ramificación es mejorar el comportamiento en frío. Las propiedades finales se verifican después sobre el producto separado y, cuando corresponda, sobre el blend terminado.</p>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-action\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">3</span>¿Qué hace Isomerization?</div>\n          <p><strong>Reorganiza la misma molécula para volverla más ramificada.</strong> No la convierte nuevamente en grasa ni busca quitarle el carbono; modifica principalmente la estructura del hidrocarburo.</p>\n          <p class=\"hdo-callout\">Las ramificaciones dificultan el empaquetamiento y ayudan a mantener el combustible líquido a temperaturas más bajas.</p>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-shape\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">4</span>Transformación molecular</div>\n          <div class=\"hdo-equation\">\n            <div class=\"hdo-caption\">ANTES · Parafina lineal</div>\n            <div class=\"hdo-molecule-line\">C–C–C–C–C–C–C–C</div>\n            <div>+ H₂ (hidrógeno)</div>\n            <div class=\"hdo-arrow\">↓ Reactor + catalizador ↓</div>\n            <div class=\"hdo-caption\">DESPUÉS · Iso-parafina ramificada</div>\n            <div class=\"isom-branch\">      C\n      │\nC–C–C–C–C–C–C</div>\n          </div>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-controls\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">5</span>¿Con qué variables se ajusta Stage 2?</div>\n          <p>Estas variables se ajustan en conjunto para controlar la <strong>severidad</strong> y el equilibrio entre ramificación, hydrocracking y rendimiento líquido.</p>\n          <div class=\"isom-variable-grid\">\n            <div class=\"isom-variable\"><b>Temperatura del reactor</b>Es uno de los principales controles de severidad. Una operación más severa puede aumentar la transformación, pero también el cracking.</div>\n            <div class=\"isom-variable\"><b>Presión / presión parcial de H₂ (hidrógeno)</b>Mantiene disponible el hidrógeno y contribuye a un ambiente estable para las reacciones y el catalizador.</div>\n            <div class=\"isom-variable\"><b>Relación H₂ (hidrógeno)/hidrocarburo</b>Indica cuánto hidrógeno circula respecto de la alimentación y ayuda a sostener la disponibilidad de H₂ (hidrógeno) y el control térmico.</div>\n            <div class=\"isom-variable\"><b>LHSV / tiempo de contacto</b>Una LHSV menor significa, en general, más tiempo de contacto con el catalizador; una LHSV mayor implica menos tiempo.</div>\n            <div class=\"isom-variable\"><b>Flujo de alimentación</b>Cambia la carga del reactor y está relacionado con el tiempo de residencia y la velocidad espacial.</div>\n            <div class=\"isom-variable\"><b>Actividad y selectividad del catalizador</b>Definen cuánto se favorece la isomerización frente al hydrocracking. Son principalmente variables de diseño y condición del catalizador.</div>\n          </div>\n          <div class=\"isom-severity-map\">\n            <div class=\"main\">Temperatura + H₂ (hidrógeno) + LHSV/tiempo de contacto + flujo + catalizador</div>\n            <div class=\"hdo-arrow\">↓</div>\n            <div class=\"main\">Severidad de Stage 2</div>\n            <div class=\"hdo-arrow\">↓</div>\n            <div class=\"tradeoff\">Ramificación ↔ acortamiento de cadenas ↔ rendimiento líquido</div>\n          </div>\n          <p class=\"hdo-callout\">La operación no busca simplemente “más reacción”: busca suficiente isomerización para mejorar el desempeño en frío y únicamente el hydrocracking necesario para ajustar el producto.</p>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-carbon\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">6</span>¿Cambia el número de carbonos?</div>\n          <div class=\"isom-distinction\">\n            <div><b>Isomerización</b>Conserva prácticamente el mismo número de carbonos y cambia principalmente su forma.</div>\n            <div><b>Selective hydrocracking</b>Puede romper algunas cadenas largas y producir moléculas más cortas.</div>\n          </div>\n          <p>El hydrocracking selectivo ayuda a ajustar parte de la corriente hacia el rango molecular apropiado para jet fuel, pero no debe confundirse con la isomerización pura.</p>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-output\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">7</span>¿Qué sale?</div>\n          <ul class=\"correction-list\">\n            <li>Iso-parafinas / parafinas ramificadas</li>\n            <li>Algunas cadenas más cortas por hydrocracking</li>\n            <li>Otros hidrocarburos renovables</li>\n          </ul>\n          <p class=\"hdo-callout\">SAF, diésel renovable, nafta y gases todavía no están separados físicamente; continúan como una mezcla de hidrocarburos.</p>\n        </div>\n\n        <div class=\"hdo-card isom-card isom-next\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">8</span>¿Qué pasa después?</div>\n          <p>La corriente desoxigenada, ramificada y parcialmente ajustada en longitud pasa a <strong>08 · Separation / Fractionation</strong>.</p>\n          <div class=\"hdo-next-flow\">\n            <div>Mezcla de hidrocarburos</div>\n            <div class=\"hdo-arrow\">↓</div>\n            <div>Separación por rango de ebullición</div>\n            <div class=\"hdo-arrow\">↓</div>\n            <div>Gases · nafta · SAF · diésel renovable</div>\n          </div>\n        </div>\n\n        <p class=\"hdo-key\">HDO cambia la naturaleza de la molécula: grasa → hidrocarburo.<br>Isomerization cambia su forma: cadena lineal → cadena ramificada.<br>Fractionation separa los hidrocarburos por su rango de ebullición.</p>\n      </div>\n    </div>\n  </details>\n</div>";

  eco.dataset.isomerizationVisualV72='true';
})();


/* v74 · Separation y Fractionation visual y desplegable */
(()=>{
  const eco=document.querySelector('.ecofining-board');
  if(!eco||eco.dataset.separationVisualV74==='true') return;

  const lower07=eco.querySelector('.eco-strip2 > .isom-stage');
  const lower08=lower07?.nextElementSibling;
  if(!lower08) return;

  const panelTitle=lower08.querySelector('.panel-title');
  const explain=lower08.querySelector('.stage-explain');
  lower08.classList.add('separation-stage');
  if(panelTitle) panelTitle.textContent='Separación física de productos';
  if(explain) explain.innerHTML="<div class=\"pretreatment-explainer separation-summary\">\n  <p class=\"explainer-lead\">La grasa ya fue convertida y ajustada molecularmente. Ahora entra una <strong>mezcla de hidrocarburos de diferentes tamaños</strong> que debe separarse físicamente en corrientes de producto.</p>\n\n  <div class=\"correction-card hdo-summary-input\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">+</span><strong>Entra a Separation / Fractionation</strong></div>\n    <ul class=\"correction-list\">\n      <li>Gases e hidrocarburos ligeros</li>\n      <li>Moléculas ligeras tipo nafta</li>\n      <li>Hidrocarburos en rango jet</li>\n      <li>Hidrocarburos más pesados tipo diésel renovable</li>\n    </ul>\n  </div>\n\n  <div class=\"correction-card separation-summary-action\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">↓</span><strong>Se separa físicamente</strong></div>\n    <ul class=\"correction-list\">\n      <li>Enfriamiento y separación inicial entre gases y líquidos</li>\n      <li>Destilación / fractionation de la corriente líquida</li>\n      <li>Separación según propiedades y rangos de ebullición</li>\n      <li>No se busca una nueva reacción química</li>\n    </ul>\n    <div class=\"hdo-equation\">\n      <div>Mezcla de hidrocarburos</div>\n      <div class=\"hdo-arrow\">↓ Enfriamiento + separación + destilación</div>\n      <div>Corrientes de producto</div>\n    </div>\n  </div>\n\n  <div class=\"correction-card correction-keep\">\n    <div class=\"correction-card-title\"><span class=\"correction-flow-icon\">→</span><strong>Salen corrientes separadas</strong></div>\n    <ul class=\"correction-list\">\n      <li>Gases ligeros</li>\n      <li>Nafta renovable</li>\n      <li>Corte jet / SAF</li>\n      <li>Diésel renovable</li>\n    </ul>\n    <div class=\"correction-destination\">El corte jet todavía debe cumplir las especificaciones aplicables y, cuando corresponda, pasar por blending. Estar en el rango jet no significa automáticamente que ya sea SAF certificado.</div>\n  </div>\n\n  <details class=\"explainer-detail\">\n    <summary>Ver explicación guiada · ¿cómo se separa la mezcla en gases, nafta, SAF y diésel renovable?</summary>\n    <div class=\"explainer-body hdo-detail-body\">\n      <div class=\"hdo-explainer separation-explainer\">\n        <div class=\"hdo-card separation-card separation-input\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">1</span>¿Qué entra?</div>\n          <p>Entra una <strong>mezcla de hidrocarburos isomerizados</strong> procedente de Stage 2. Contiene moléculas de distintos tamaños: gases, componentes ligeros, moléculas en rango jet y componentes más pesados.</p>\n          <p class=\"hdo-callout\">Entra una “sopa” de hidrocarburos de diferentes tamaños y propiedades.</p>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-problem\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">2</span>¿Cuál es el problema?</div>\n          <p>Aunque la grasa ya se convirtió en hidrocarburos, <strong>todos siguen mezclados</strong>. Una corriente con C3, C5, C8, C12, C15, C17 y C18 no puede considerarse directamente SAF.</p>\n          <div class=\"hdo-equation\">\n            <div>C3 · C5 · C8 · C12 · C15 · C17 · C18</div>\n            <div class=\"hdo-arrow\">↓ Deben separarse</div>\n            <div>Gases · nafta · corte jet · diésel renovable</div>\n          </div>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-steps\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">3</span>¿Qué significa Separation y Fractionation?</div>\n          <div class=\"separation-two-step\">\n            <div class=\"separation-step-box\"><b>Separation</b>La corriente se enfría y se realiza una separación inicial entre gases y líquidos. Puede retirarse H₂ (hidrógeno) no reaccionado, gases ligeros y otros componentes gaseosos, dependiendo del tren y su tratamiento.</div>\n            <div class=\"separation-step-box\"><b>Fractionation</b>La corriente líquida entra a columnas de destilación y se divide en cortes de producto de acuerdo con sus propiedades y rangos de ebullición.</div>\n          </div>\n          <div class=\"hdo-equation\">\n            <div>Corriente del reactor</div>\n            <div class=\"hdo-arrow\">↓ Enfriamiento</div>\n            <div>Separador gas–líquido</div>\n            <div class=\"hdo-arrow\">↓</div>\n            <div>Gases　|　Líquido hacia fractionation</div>\n          </div>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-tower-card\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">4</span>¿Cómo funciona la torre?</div>\n          <p>Los componentes ligeros hierven y ascienden con mayor facilidad. Los componentes con mayor punto de ebullición se recuperan en zonas inferiores.</p>\n          <div class=\"separation-tower\">\n            <div class=\"tower-direction\">↑ Más ligero / menor rango de ebullición</div>\n            <div class=\"tower-cut\">Gases</div>\n            <div class=\"tower-cut\">Nafta renovable</div>\n            <div class=\"tower-cut\">Corte jet / SAF</div>\n            <div class=\"tower-cut\">Diésel renovable</div>\n            <div class=\"tower-direction\">↓ Más pesado / mayor rango de ebullición</div>\n          </div>\n          <p>No significa que cada producto sea una sola molécula: cada corriente contiene un <strong>rango de hidrocarburos con propiedades de destilación similares</strong>.</p>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-physical\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">5</span>¿Qué ocurre químicamente?</div>\n          <p><strong>Prácticamente no se busca una nueva transformación química.</strong> La etapa enfría, separa gases y líquidos y destila la corriente según diferencias físicas de volatilidad y ebullición.</p>\n          <p class=\"hdo-callout\">Stage 1 cambia la naturaleza de la molécula; Stage 2 cambia su forma y, en parte, su tamaño; Stage 3 separa físicamente los productos.</p>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-output\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">6</span>¿Qué sale?</div>\n          <div class=\"separation-product-grid\">\n            <div class=\"separation-product\"><b>Gases ligeros</b>Propano y otros componentes gaseosos o muy ligeros.</div>\n            <div class=\"separation-product\"><b>Nafta renovable</b>Fracción relativamente ligera que puede manejarse como coproducto renovable.</div>\n            <div class=\"separation-product\"><b>Corte jet / SAF</b>Hidrocarburos recuperados dentro del rango de destilación buscado para combustible de aviación.</div>\n            <div class=\"separation-product\"><b>Diésel renovable</b>Fracción de hidrocarburos más pesados dentro de la corriente líquida útil.</div>\n          </div>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-example\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">7</span>Ejemplo conceptual</div>\n          <div class=\"separation-carbon-map\">\n            <div class=\"separation-carbon-row\"><b>C3</b><span>Componente gaseoso</span></div>\n            <div class=\"separation-carbon-row\"><b>C5–C8</b><span>Fracción ligera / nafta en este ejemplo</span></div>\n            <div class=\"separation-carbon-row\"><b>C9–C16</b><span>Posible rango jet en este ejemplo simplificado</span></div>\n            <div class=\"separation-carbon-row\"><b>Más pesados</b><span>Fracción tipo diésel renovable</span></div>\n          </div>\n          <p class=\"hdo-callout\">Estos números son únicamente ilustrativos. En planta, los cortes no se definen mediante fronteras rígidas de número de carbonos, sino mediante propiedades, especificaciones y rangos de destilación.</p>\n        </div>\n\n        <div class=\"hdo-card separation-card separation-certify\">\n          <div class=\"hdo-card-title\"><span class=\"hdo-number\">8</span>¿Qué significa obtener un corte jet?</div>\n          <p>Significa que se recuperó una fracción con un rango de volatilidad y ebullición orientado a jet fuel. <strong>No significa automáticamente que el producto ya esté certificado para aviación.</strong></p>\n          <p>La corriente todavía debe verificarse contra las especificaciones aplicables y posteriormente puede requerir blending, según la ruta y certificación correspondientes.</p>\n        </div>\n\n        <p class=\"hdo-key\">HDO convierte: grasa → hidrocarburos.<br>Isomerization ajusta: forma y tamaño molecular.<br>Separation / Fractionation separa: gases · nafta · corte jet / SAF · diésel renovable.</p>\n      </div>\n    </div>\n  </details>\n</div>";
