/* v79 · Tratamientos adicionales según feedstock + liberación técnica antes de envío a Tula */
(()=>{
  const run=()=>{
    ...
    style.textContent=`
      ...
      .ecofining-board .eco-additional-treatment-col .additional-treatment-list{
        display:grid;gap:7px;margin-top:2px;
      }
      .ecofining-board .eco-additional-treatment-col .additional-treatment-item{
        padding:8px 10px;border:1px solid var(--line);border-radius:10px;
        background:rgba(255,255,255,.72);font-size:12px;line-height:1.35;color:var(--text-soft);
      }
      .ecofining-board .eco-additional-treatment-col .additional-treatment-item b{color:var(--blue-1)}
    ...
    additional.innerHTML=`
      ...
      <div class="desc dual-desc">
        <div class="desc-point"><b>Cuándo aplica:</b> No es una etapa obligatoria para todos los lotes. Se incorporan módulos adicionales cuando el tren base no es suficiente para alcanzar la especificación HVO/HEFA.</div>
        <div class="additional-treatment-list">
          <div class="additional-treatment-item"><b>Heat treatment:</b> tratamiento térmico para facilitar la remoción de contaminantes difíciles.</div>
          <div class="additional-treatment-item"><b>Chloride removal:</b> reduce compuestos de cloro que pueden generar corrosión o afectar el procesamiento posterior.</div>
          <div class="additional-treatment-item"><b>Polymer / polyethylene removal:</b> retira plásticos o polímeros que pueden generar depósitos, ensuciamiento u obstrucciones.</div>
          <div class="additional-treatment-item"><b>Deacidification / neutralization:</b> reduce FFA cuando la configuración del pretratamiento o del proceso posterior lo requiere.</div>
          <div class="additional-treatment-item"><b>Otros tratamientos específicos:</b> operaciones adicionales definidas según la composición del feedstock y la especificación requerida.</div>
        </div>
      </div>
    ...
    additionalStage.innerHTML=`
      ...
      <div class="checkpoint-decision"><b>Validar con proveedor / tecnólogo:</b> qué tratamientos adicionales se usan realmente, para qué feedstocks, quién los realiza y en qué punto del tren se integran.</div>`;
    ...
    release.innerHTML=`
      ...
      <div class="desc dual-desc">
        <div class="desc-point"><b>Proceso:</b> Después del pretratamiento se muestrea y analiza el material para confirmar si cumple la especificación requerida antes de enviarlo a Tula.</div>
        <div class="desc-point"><b>Decisión:</b> El lote puede liberarse, corregirse o rechazarse según los resultados. Este punto separa el acondicionamiento del feedstock de la logística hacia Tula.</div>
      </div>
    ...
    /* v76 usa 15 columnas. v79 agrega 02A.5 y 02B como dos columnas adicionales. */
